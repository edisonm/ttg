...
uses
  ...
  FSingEdt, Sqlite3DS, FCrsMME0, FEditor, UConfig;
type
  TMainForm = class(TForm)
    ...
    QuParaleloHora: TSqlite3Dataset;
    QuParaleloHoraCodNivel: TLongIntField;
    QuParaleloHoraCodEspecializacion: TLongIntField;
    QuParaleloHoraCodParaleloId: TLongIntField;
    QuParaleloHoraCodHora: TLongIntField;
    QuParaleloHoraNomHora: TStringField;
    QuProfesorHora: TSqlite3Dataset;
    QuProfesorHoraCodProfesor: TLongIntField;
    QuProfesorHoraCodHora: TLongIntField;
    QuProfesorHoraNomHora: TStringField;
    QuProfesorHorarioDetalle: TSqlite3Dataset;
    QuParaleloHorarioDetalle: TSqlite3Dataset;
    TbMateria: TSqlite3Dataset;
    QuMateriaMateriaProhibicion: TSqlite3Dataset;
    QuMateriaMateriaProhibicionCodMateria: TLongIntField;
    QuMateriaMateriaProhibicionNomMateria: TStringField;
    QuMateriaMateriaProhibicionHora: TSqlite3Dataset;
    QuMateriaMateriaProhibicionHoraCodMateria: TLongIntField;
    QuMateriaMateriaProhibicionHoraCodHora: TLongIntField;
    QuMateriaMateriaProhibicionHoraNomHora: TStringField;
    QuProfesorProfesorProhibicion: TSqlite3Dataset;
    QuProfesorProfesorProhibicionApeProfesor: TStringField;
    QuProfesorProfesorProhibicionNomProfesor: TStringField;
    QuProfesorProfesorProhibicionCodProfesor: TLongIntField;
    QuProfesorProfesorProhibicionHora: TSqlite3Dataset;
    QuProfesorProfesorProhibicionHoraCodProfesor: TLongIntField;
    QuProfesorProfesorProhibicionHoraCodHora: TLongIntField;
    QuProfesorProfesorProhibicionHoraNomHora: TStringField;
    TbProfesor1: TSqlite3Dataset;
    ...
    QuParaleloHorarioDetalleCodNivel: TLongIntField;
    QuParaleloHorarioDetalleCodEspecializacion: TLongIntField;
    QuParaleloHorarioDetalleCodParaleloId: TLongIntField;
    QuParaleloHorarioDetalleCodDia: TLongIntField;
    QuParaleloHorarioDetalleCodHora: TLongIntField;
    QuParaleloHorarioDetalleCodMateria: TLongIntField;
    QuParaleloHorarioDetalleNomMateria: TStringField;
    QuProfesorHorarioDetalleCodProfesor: TLongIntField;
    QuProfesorHorarioDetalleCodDia: TLongIntField;
    QuProfesorHorarioDetalleCodHora: TLongIntField;
