...
uses
  Classes, DB, Dialogs, SysConst, Math, Forms, Sqlite3DS;
type
...
var
  ...
  procedure Cargar(ATable: TSqlite3Dataset; ALstName: string; var FMinCodLst:
  ...
  var
    i, j, k: Integer;
    VFieldNivel, VFieldEspecializacion: TLongIntField;
  begin
    ...
    begin
      ...
      VFieldNivel := FindField('CodNivel') as TLongIntField;
      VFieldEspecializacion := FindField('CodEspecializacion') as TLongIntField;
  ...
  var
    i, j, k: Integer;
    VFieldDia, VFieldHora: TLongIntField;
  begin
    ...
    begin
      ...
      VFieldDia := FindField('CodDia') as TLongIntField;
      VFieldHora := FindField('CodHora') as TLongIntField;
  ...
  var
    i, j, k, l, m: Integer;
    VFieldNivel, VFieldEspecializacion, VFieldParaleloId: TLongIntField;
  begin
    ...
    begin
      ...
      VFieldNivel := FindField('CodNivel') as TLongIntField;
      VFieldEspecializacion := FindField('CodEspecializacion') as TLongIntField;
      VFieldParaleloId := FindField('CodParaleloId') as TLongIntField;
  ...
  begin
    ...
    begin
      ...
      VFieldCantidad := FindField('Cantidad') as TLongIntField;
      for i := 0 to RecordCount - 1 do
      begin
  ...
  begin
    ...
    begin
      ...
      VFieldMateria := FindField('CodMateria') as TLongIntField;
      VFieldDia := FindField('CodDia') as TLongIntField;
      VFieldHora := FindField('CodHora') as TLongIntField;
      ...
      begin
        ...
        k := FDiaHoraAPeriodo[FCodDiaADia[VFieldDia.Value -
    ...
    begin
      ...
      for p := 0 to FProfesorCant - 1 do
        FillChar(FProfesorPeriodoAProfesorProhibicionTipo[p, 0],
          FPeriodoCant * sizeof(Shortint), #$FF);
      VFieldProfesor := FindField('CodProfesor') as TLongIntField;
      VFieldHora := FindField('CodHora') as TLongIntField;
      VFieldDia := FindField('CodDia') as TLongIntField;
  ...
  var
    ...
    VFieldMateria, VFieldNivel, VFieldParaleloId, VFieldProfesor,
      VFieldEspecializacion, VFieldAulaTipo: TLongIntField;
  ...
  begin
    ...
    begin
      ...
      VFieldParaleloId := FindField('CodParaleloId') as TLongIntField;
      VFieldProfesor := FindField('CodProfesor') as TLongIntField;
      VFieldAulaTipo := FindField('CodAulaTipo') as TLongIntField;
      ...
      begin
        ...
        q := FCodEspecializacionAEspecializacion[VFieldEspecializacion.Value -
          FMinCodEspecializacion];
        a := FCodAulaTipoAAulaTipo[VFieldAulaTipo.Value - FMinCodAulaTipo];
...
var
  ...
  var
    FieldHorario, FieldNivel, FieldParaleloId, FieldEspecializacion, FieldDia,
      FieldHora, FieldMateria, FieldSesion: TLongIntField;
    i, j, k, l, m, s: Integer;
  begin
    ...
    begin
      ...
      try
        Last;
        FieldHorario := FindField('CodHorario') as TLongIntField;
        ...
        FieldMateria := FindField('CodMateria') as TLongIntField;
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              FieldDia.Value := FDiaACodDia[FPeriodoADia[j]];
              FieldHora.Value := FHoraACodHora[FPeriodoAHora[j]];
