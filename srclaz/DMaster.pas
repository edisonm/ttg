...
uses
  ...
  DB, Sqlite3DS, TTGUtls, Variants;

type
  TMasterDataModule = class(TDataModule)
    TbTmpProfesorCarga: TSqlite3Dataset;
    ...
    QuDistributivoProfesor: TSqlite3Dataset;
