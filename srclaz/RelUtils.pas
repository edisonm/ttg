...
procedure CheckMasterRelationUpdate(AMaster: TDataSet; ADetail: TSqlite3Dataset;
  const AMasterFields, ADetailFields: string; ACascade: Boolean);
procedure CheckMasterRelationDelete(AMaster: TDataSet; ADetail: TSqlite3Dataset;
  const AMasterFields, ADetailFields: string; ACascade: Boolean);
procedure CheckDetailRelation(AMaster: TDataSet; ADetail: TSqlite3Dataset;
