...
begin
  ...
  begin
    ...
    Add('TbCluster.IdLevel=' + SFlCluster_IdLevel);
    Add('TbCluster.IdSpecialization=' + SFlCluster_IdSpecialization);
    ...
    Add('TbJoinedCluster.IdLevel=' + SFlJoinedCluster_IdLevel);
    Add('TbJoinedCluster.IdSpecialization=' + SFlJoinedCluster_IdSpecialization);
    Add('TbJoinedCluster.IdParallel=' + SFlJoinedCluster_IdParallel);
    Add('TbJoinedCluster.IdLevel1=' + SFlJoinedCluster_IdLevel1);
    Add('TbJoinedCluster.IdSpecialization1=' + SFlJoinedCluster_IdSpecialization1);
