...
resourcestring
  ...
  SFlCluster_IdLevel = 'Level';
  SFlCluster_IdSpecialization = 'Specialization';
  ...
  SFlJoinedCluster_IdLevel = 'Level';
  SFlJoinedCluster_IdSpecialization = 'Specialization';
  SFlJoinedCluster_IdParallel = 'Parallel';
  SFlJoinedCluster_IdLevel1 = 'Joined Level';
  SFlJoinedCluster_IdSpecialization1 = 'Joined Specialization';
