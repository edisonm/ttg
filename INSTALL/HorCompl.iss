...
UninstallIconName=Desinstalación de Horarios para Colegio 1.0
Uninstallable=1
AllowNoIcons=0
AlwaysRestart=0
CompressLevel=9
...
Source: ..\BAT\BZIP2.EXE; DestDir: {app}\SRC\SGHC\1.0\BAT\; DestName: BZIP2.EXE
Source: ..\BAT\TAR.EXE; DestDir: {app}\SRC\SGHC\1.0\BAT\; DestName: TAR.EXE
Source: C:\Archivos de programa\Archivos comunes\Borland\BDE\bdeinst.dll; DestDir: {tmp}\PACKS\; DestName: BDEINST.DLL; Flags: uninsneveruninstall
